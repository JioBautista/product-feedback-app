...
function NavBar() {
  ...
  return (
    <>
      <div className="bg-blue-500 relative md:bg-[#F7F8FD] px-5 md:pt-10 md:mb-6 lg:col-start-1 lg:row-start-1 lg:row-end-4 lg:p-0 lg:max-w-[250px] lg:justify-self-end">
