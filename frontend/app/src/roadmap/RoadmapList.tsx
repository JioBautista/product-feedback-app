    ...
    <>
      {data?.map((items: Data) => (
        ...
        >
          ...
          <span className="bg-blue-100 text-blue-500 font-semibold px-5 py-2 rounded-lg inline-block">
            {items.category}
          </span>
          <div className="flex justify-between items-center w-full">
            <button className="bg-blue-100 font-semibold px-5 py-2 rounded-lg flex items-center gap-2 hover:bg-purple-300">
